...
import 'package:flutter_xupdate_ae/flutter_xupdate.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  UpdateEntity customParseJson(String json) {
    var appInfo = AppInfo.fromJson(json);
    print(appInfo);
    return UpdateEntity(
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: const Text('flutter_xupdate Demo')),
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                ...
                color: Colors.grey,
                padding: const EdgeInsets.all(10),
                child: Text(_message, style: const TextStyle(color: Colors.white, fontSize: 12)),
              ),
              autoFitWidget(
                ButtonBar(
  ...
  final String _updateUrl = 'https://gitee.com/xuexiangjys/XUpdate/raw/master/jsonapi/update_test.json';

  final String _updateUrl2 = 'https://gitee.com/xuexiangjys/XUpdate/raw/master/jsonapi/update_forced.json';

  final String _updateUrl3 = 'https://gitee.com/xuexiangjys/XUpdate/raw/master/jsonapi/update_custom.json';
